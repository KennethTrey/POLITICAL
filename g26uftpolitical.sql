...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2019 at 12:55 PM
...
CREATE TABLE `agents` (
  ...
  `wageUnits` int(11) NOT NULL,
  `wage_per_unit` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, '2019_06_15_100018_create_districts_table', 1),
(4, '2019_06_15_102644_create_agents_table', 1),
(5, '2019_06_15_102727_create_members_table', 1),
(6, '2019_06_15_102753_create_donations_table', 1),
(7, '2019_06_15_102844_create_admins_table', 1);
